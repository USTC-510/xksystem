<template>
    <div class="container main">
      ...
      <table>
        ...
        <tr v-for="course in filteredCourses" :key="course.id">
          ...
          <td v-else><input v-model="course.name" /></td>
          <td v-if="editMode">{{ course.time }}</td>
          <td v-else><input v-model="course.time" /></td>
          <td v-if="editMode">{{ course.position }}</td>
          <td v-else><input v-model="course.position" /></td>
          <td v-if="editMode">{{ course.credits }}</td>
          <td v-else><input v-model="course.credits" /></td>
          <td v-if="editMode">{{ course.hour }}</td>
          <td v-else><input v-model="course.hour" /></td>
  ...
  export default {
    ...
    methods: {
        ...
        trackChanges(courseId, field, value) {
            if (!this.changes[courseId]) {
                this.changes[courseId] = {};
            }
            this.changes[courseId][field] = value;
        },
        saveChanges() {
